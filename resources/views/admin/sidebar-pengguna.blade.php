    ...
    <div class="interactive-table" style="margin-bottom: 30px;">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center text-muted py-3" style="text-align: center; padding: 20px; color: #6b7280;">Belum ada data mahasiswa.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="interactive-table">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center text-muted py-3" style="text-align: center; padding: 20px; color: #6b7280;">Belum ada data dosen.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
