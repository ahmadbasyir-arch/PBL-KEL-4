...
<div class="welcome-banner">
    <h1>Selamat Datang, {{ ucwords(Auth::user()->name ?? Auth::user()->username ?? 'Mahasiswa') }}! 👋</h1>
    <p>Anda login sebagai Mahasiswa. Berikut adalah ringkasan aktivitas peminjaman Anda.</p>
</div>
